# -*- coding: utf-8 -*-
"""
Created on Fri Mar 17 21:43:38 2023
...
img = cv2.imread(r"C:/Users/91892/TTIE_imgs/ttieOutput2.png", 1)
...
def handle_send_message_event(data):
    ...
    cv2.imwrite(r"C:/Users/91892/TTIE_imgs/ttieOutput2Enc.png", EncryptionImg)

    # =========================================
    # IMAGE DECRYPTION
    img = cv2.imread(r"C:/Users/91892/TTIE_imgs/ttieOutput2Enc.png", 1)
    DecryptionImg = np.zeros(img.shape, np.uint8)
    imageDecryption(img, 10, 30, 0.123345, DecryptionImg)

    # Saving the Decrypted Image
    cv2.imwrite(r"C:/Users/91892/TTIE_imgs/ttieOutput2Dec.png", DecryptionImg)
